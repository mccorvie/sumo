...
select( matchNo, eastShikona, record_east, elo_east, pwin_east, win,  westShikona, record_west, elo_west, pwin_west, surprisal)
...
gt( post_sheet) |>
  ...
  tab_spanner(
    label = "East",
    columns = c( eastShikona, record_east, elo_east, pwin_east )
  ) |>
  tab_spanner(
    label = "West",
    columns = c( westShikona, record_west, elo_west, pwin_west)
  ...
  tab_style(
    ...
    locations = cells_body(
      columns = c( `pwin_east`, `win`, `pwin_west` )
    )
  )
