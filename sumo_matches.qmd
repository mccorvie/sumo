...
Welcome to the rikishi Elo scoreboard! This page gives you a quick way to see who’s looking strongest in the current basho. Each wrestler has an Elo rating, which goes up when they win and down when they lose, so the numbers shift day by day as the action unfolds.
...
If you’d like to dive into the math behind it all, check out the [Elo model details](elo_sumo.html)
...
match_sheet <- match_sheet |> 
  mutate( 
    ...
    `Headshot E` = paste0( "headshots/", eastShikona, ".jpg"),
    `Headshot W` = paste0( "headshots/", westShikona, ".jpg")
  ) 
